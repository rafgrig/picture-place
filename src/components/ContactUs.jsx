    ...
    <div className="containerContactUS">
      <div className="image-container">
        <img
          ...
          alt="Contact Us"
        />
        <div className="mini1-overlay">
          {" "}
          Addres: <br />
          1 Brown Street, Sheffield, S1 <br />
          2BS
          <br />
        </div>

        <div className="mini2-overlay">
          Phone Number: <br />
          +44 (0) 114 2812077
          <br />
        </div>

        <div className="mini3-overlay">
          Email: <br />
          esiminch@gallery.org
        </div>
      </div>
      <div className="image-container">
        <img
          ...
          alt="Contact Us"
        />
        <div className="gInfo-overlay">Gallery company</div>
        <div className="mini4-overlay">
          {" "}
          Register Number: <br />
          1234567
          <br />
